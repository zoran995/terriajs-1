...
LeafletGeomVisualizer.prototype._updatePoint = function(
  ...
  var interactive = Property.getValueOrDefault(
    pointGraphics.interactive,
    time,
    defaultInteractive
  );
...
LeafletGeomVisualizer.prototype._updateLabel = function(
  ...
  /**
   * Drawn feature should populate interactive property to make label unclickable
   */
  var interactive = Property.getValueOrDefault(
    labelGraphics.interactive,
    time,
    defaultInteractive
  );
