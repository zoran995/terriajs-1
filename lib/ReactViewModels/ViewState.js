...
export default class ViewState {
  constructor(options) {
    ...
    /**
     * Gets or sets a value indicating whether the attribute table is visible.
     */
    this.attributeTablePanelIsVisible = false;

    /**
     * Gets or sets a value indicating whether the attribute table is collapsed.
     */
    this.attributeTablePanelIsCollapsed = false;
