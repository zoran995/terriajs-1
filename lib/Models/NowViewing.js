 ...
 * Also removes attribute table from map for this item.
 *
...
NowViewing.prototype.remove = function(item) {
  ...
  if (this._terria.attributeTableCatalogItem === item) {
    //remove attribute table if opened for this dataset
    this._terria.attributeTableCatalogItem = undefined;
  }
};

/**
 * Removes all data sources from the "Now Viewing" pane and from the map.
 * Also removes attribute table from map.
 */
NowViewing.prototype.removeAll = function() {
  ...
  //remove attribute table if opened
  this._terria.attributeTableCatalogItem = undefined;
};
